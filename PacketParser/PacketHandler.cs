...
namespace PacketParser {
    ...
    public class PacketHandler {
        ...
        public PacketHandler(string applicationExecutablePath, string outputPath, List<Fingerprints.IOsFingerprinter> preloadedFingerprints, bool ignoreMissingFingerprintFiles, Func<DateTime, string> toCustomTimeZoneStringFunction) {
        ...
        public Frame GetFrame(DateTime timestamp, byte[] data, NetresecShared.Pcap.PcapFrame.DataLinkTypeEnum dataLinkType) {
